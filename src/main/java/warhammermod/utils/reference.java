...
public class reference {
    ...
    //public static final ItemGroup warhammer = FabricItemGroupBuilder.build(new Identifier(reference.modid,"warhammer"),()-> new ItemStack(ItemsInit.GHAL_MARAZ));
    public static final Identifier Dwarf_warrior = Identifier.of(modid,"warrior");
    public static final Identifier Dwarf_slayer = Identifier.of(modid,"slayer");
    public static final Identifier Dwarf_engineer = Identifier.of(modid,"engineer");
    public static final Identifier Dwarf_miner = Identifier.of(modid,"miner");
    public static final Identifier Dwarf_lord = Identifier.of(modid,"lord");
    public static final Identifier Dwarf_builder = Identifier.of(modid,"builder");
    public static final Identifier Dwarf_farmer = Identifier.of(modid,"farmer");
