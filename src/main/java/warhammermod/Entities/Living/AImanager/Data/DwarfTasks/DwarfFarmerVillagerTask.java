...
public class DwarfFarmerVillagerTask extends MultiTickTask<DwarfEntity> {
    ...
    public DwarfFarmerVillagerTask() {
    ...
    protected boolean shouldRun(ServerWorld serverWorld, DwarfEntity villagerEntity) {
        if (!serverWorld.getGameRules().getBoolean(GameRules.DO_MOB_GRIEFING)) {
            return false;
        } else if (villagerEntity.getProfession() != DwarfProfessionRecord.FARMER) {
            return false;
        } else {
