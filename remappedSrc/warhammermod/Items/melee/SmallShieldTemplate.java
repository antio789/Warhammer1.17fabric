...
public class SmallShieldTemplate extends ShieldItem {
    ...
    private static final EntityAttributeModifier BLOCKING_SPEED_BOOST = new EntityAttributeModifier(BLOCKING_SPEED_BOOST_ID, "blocking speed boost", 2D, EntityAttributeModifier.Operation.ADD_MULTIPLIED_TOTAL);
    private static final UUID SPRINT_SPEED_BOOST_ID = UUID.fromString("662A6B8D-DA3C-4F1D-8814-96EA6197278D");
    private static final EntityAttributeModifier SPRINT_SPEED_BOOST = (new EntityAttributeModifier(SPRINT_SPEED_BOOST_ID, "sprint speed boost", 3.5D, EntityAttributeModifier.Operation.ADD_MULTIPLIED_TOTAL));
