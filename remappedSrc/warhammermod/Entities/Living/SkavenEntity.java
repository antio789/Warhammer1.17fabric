...
public class SkavenEntity extends HostileEntity implements RangedAttackMob {
    ...
    public void shootAt(LivingEntity target, float p_82196_2_) {
    ...
    private void attackpotions(LivingEntity target){
        ...
        potionentity.setItem(PotionContentsComponent.setPotion(new ItemStack(Items.LINGERING_POTION), potion));
