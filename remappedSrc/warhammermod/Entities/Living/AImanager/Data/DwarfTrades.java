...
public class DwarfTrades {
   ...
   private static class TippedArrowForItemsAndEmeralds implements TradeOffers.Factory {
      ...
      public TradeOffer create(Entity entity, Random random) {
         ...
         ItemStack itemStack2 = PotionContentsComponent.setPotion(new ItemStack(this.toItem.getItem(), this.toCount), potion);
   ...
   private static class TreasureMapForEmeralds implements TradeOffers.Factory {
      ...
      public TreasureMapForEmeralds(int i, Structure<?> structureFeature, MapDecoration.Type type, int j, int k) {
         this.emeraldCost = i;
